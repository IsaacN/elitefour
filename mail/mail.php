...
$emailSubject               = 'Elite Four Site Enquiry'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Elite Four';                // REQUIRED value. This is used when a name or email is not collected from the website form
